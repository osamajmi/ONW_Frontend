          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="bg-surface-elevated/40 border border-border/80 backdrop-blur-md rounded-2xl p-8 relative overflow-hidden">
                ...
                <h3 className="font-display text-xl font-bold mb-2">Build Your Noida Web Project</h3>
                <p className="text-muted-foreground text-sm mb-6">
                  Get a complete design mockup and transparent pricing details within 2 hours.
                </p>
                ...
                <form action="https://api.onnextweb.in/api/contact" method="POST" className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      id="hero-email" 
                      name="email" 
                      placeholder="e.g. vikas@exportbrand.com" 
                      required
                      className="w-full bg-background/50 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      name="message" 
                      rows={3} 
                      placeholder="Manufacturing business catalog, WordPress blog, or e-commerce shop?"
                      required
