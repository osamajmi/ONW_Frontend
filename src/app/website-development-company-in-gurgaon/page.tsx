          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="bg-surface-elevated/40 border border-border/80 backdrop-blur-md rounded-2xl p-8 relative overflow-hidden">
                ...
                <h3 className="font-display text-xl font-bold mb-2">Build Your Next Web Project</h3>
                <p className="text-muted-foreground text-sm mb-6">
                  Get a complete design roadmap and transparent pricing tailored to your custom specifications.
                </p>
                ...
                <form action="https://api.onnextweb.in/api/contact" method="POST" className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      id="hero-email" 
                      name="email" 
                      placeholder="e.g. anil@startuphub.com" 
                      required
                      className="w-full bg-background/50 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors"
                    />
                  </div>
                  ...
                  <div>
                    <label htmlFor="hero-message" className="block text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-wider">Describe Requirements</label>
                    <textarea 
                      id="hero-message" 
                      name="message" 
                      rows={3} 
                      placeholder="SaaS dashboard development, ecommerce, or enterprise landing page?"
                      required
              ...
              <form action="https://api.onnextweb.in/api/contact" method="POST" className="space-y-4">
                ...
                <div>
                  <textarea 
                    name="message" 
                    rows={4} 
                    placeholder="Describe your project details (e.g. static pages, custom database scaling, or dynamic CMS systems)" 
                    required 
