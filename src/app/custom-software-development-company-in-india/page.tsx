  ...
  return (
    <div className="bg-background text-foreground transition-colors duration-500 relative min-h-screen">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="bg-surface-elevated/40 border border-border/80 backdrop-blur-md rounded-2xl p-8 relative overflow-hidden">
                ...
                <h3 className="font-display text-xl font-bold mb-2">Request Software Proposal</h3>
                <p className="text-muted-foreground text-sm mb-6">
                  Submit details of your required workflows, target tech stacks, and delivery timelines.
                </p>
                ...
                <form action="https://api.onnextweb.in/api/contact" method="POST" className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="hero-email" className="block text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-wider">Work Email</label>
                    <input 
                      type="email" 
                      id="hero-email" 
                      name="email" 
                      placeholder="e.g. david@techsolutions.com" 
                      required
                      className="w-full bg-background/50 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors"
                    />
                  </div>
                  <div>
                    <label htmlFor="hero-phone" className="block text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-wider">Phone / WhatsApp</label>
                    <input 
                      type="tel" 
                      id="hero-phone" 
                      name="phone" 
                  ...
                  <div>
                    <label htmlFor="hero-message" className="block text-xs font-semibold text-muted-foreground mb-1.5 uppercase tracking-wider">Project Scope</label>
                    <textarea 
                      id="hero-message" 
                      name="message" 
                      rows={3} 
                      placeholder="Describe custom features, system integrations, or database metrics..."
                      required
      ...
      <section className="py-20 bg-surface/50 border-t border-b border-border/40 relative">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4 mb-16">
            <span className="text-primary text-xs sm:text-sm font-semibold tracking-widest uppercase">Bespoke Pricing</span>
            <h2 className="font-display text-3xl sm:text-4xl font-bold tracking-tight">
              Bespoke Software Pricing in India
            </h2>
            <p className="text-muted-foreground text-sm max-w-xl mx-auto">
              Cost-effective outsourcing pricing configured to scale software products incrementally.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-surface-elevated/40 border border-border/80 p-8 rounded-2xl relative space-y-6 hover:scale-[1.02] transition-transform duration-300 flex flex-col justify-between">
              <div>
                <h4 className="font-display text-lg font-bold text-muted-foreground">Startup MVP</h4>
                <p className="text-xs text-muted-foreground">Ideal for pre-seed startups looking to launch prototype MVPs.</p>
                <div className="my-6">
                  <span className="text-4xl font-bold text-foreground">$1,500+</span>
                  <span className="text-xs text-muted-foreground block mt-1">One-time payment starting</span>
                </div>
                <ul className="space-y-3 text-xs text-muted-foreground border-t border-border/50 pt-6">
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> React / Next.js dynamic layouts</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Automated DB integration (MongoDB)</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Basic User authentication profiles</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> 60-days support configurations</li>
                </ul>
              </div>
            ...
            <div className="bg-surface-elevated border-2 border-primary p-8 rounded-2xl relative space-y-6 hover:scale-[1.02] transition-transform duration-300 flex flex-col justify-between shadow-[0_8px_32px_rgba(255,255,255,0.02)]">
              ...
              <div>
                <h4 className="font-display text-lg font-bold text-foreground">Bespoke Custom</h4>
                <p className="text-xs text-muted-foreground">Perfect for scaling business operations, CRM, ERP, and API hubs.</p>
                <div className="my-6">
                  <span className="text-4xl font-bold text-foreground">$4,500+</span>
                  <span className="text-xs text-muted-foreground block mt-1">Depends on features specifications</span>
                </div>
                <ul className="space-y-3 text-xs text-muted-foreground border-t border-border/50 pt-6">
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Microservices architecture configuration</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Dynamic data sync dashboards charts</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Advanced API security & JWT logic</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Multi-level dashboard permissions</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> 6 Months SLA maintenance updates</li>
                </ul>
              </div>
            ...
            <div className="bg-surface-elevated/40 border border-border/80 p-8 rounded-2xl relative space-y-6 hover:scale-[1.02] transition-transform duration-300 flex flex-col justify-between">
              <div>
                <h4 className="font-display text-lg font-bold text-muted-foreground">Dedicated Developer Team</h4>
                <p className="text-xs text-muted-foreground">For scaling software products requiring continuous logic iterations.</p>
                <div className="my-6">
                  <span className="text-4xl font-bold text-foreground">$2,200/mo</span>
                  <span className="text-xs text-muted-foreground block mt-1">Per dedicated engineer starting</span>
                </div>
                <ul className="space-y-3 text-xs text-muted-foreground border-t border-border/50 pt-6">
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Full-time dedicated developer access</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Daily sprint calls & direct communication</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Complete source code repository access</li>
                  <li className="flex items-center gap-2"><Check size={12} className="text-primary" /> Elastic scaling developers based on sprints</li>
                </ul>
              </div>
              <a href="#contact-form-section" className="block text-center bg-primary/10 hover:bg-primary/20 border border-primary/20 text-primary font-medium py-3 rounded-lg text-xs mt-6 transition-all duration-300">
                Request Dedicated Team
              </a>
            </div>
          </div>
        </div>
              ...
              <form action="https://api.onnextweb.in/api/contact" method="POST" className="space-y-4">
                ...
                <div>
                  <textarea 
                    name="message" 
                    rows={4} 
                    placeholder="Describe your project details (e.g. database scaling, custom integrations, or mobile apps support)" 
                    required 
